...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lq/n;->h:[Landroid/graphics/Bitmap$Config;
...
.method public static j(Landroid/graphics/Bitmap$Config;)[Landroid/graphics/Bitmap$Config;
    ...
    .line 5
    :cond_1
    sget-object p0, Lq/n;->h:[Landroid/graphics/Bitmap$Config;
...
.method public a()Landroid/graphics/Bitmap;
    ...
    .line 2
    invoke-static {v0}, Lj0/j;->h(Landroid/graphics/Bitmap;)I
    ...
    invoke-virtual {p0, v1, v0}, Lq/n;->g(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
...
.method public b(IILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p1, p2, p3}, Lj0/j;->g(IILandroid/graphics/Bitmap$Config;)I

    move-result p0

    .line 2
    invoke-static {p0, p3}, Lq/n;->i(ILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
...
.method public c(Landroid/graphics/Bitmap;)V
    ...
    .line 3
    iget-object v1, p0, Lq/n;->b:Lq/h;

    invoke-virtual {v1, v0, p1}, Lq/h;->d(Lq/m;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lq/n;->k(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;

    move-result-object p0

    .line 5
    iget p1, v0, Lq/n$b;->b:I
...
.method public d(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 2
    invoke-virtual {p0, v0, p3}, Lq/n;->h(ILandroid/graphics/Bitmap$Config;)Lq/n$b;
    ...
    invoke-virtual {v1, v0}, Lq/h;->a(Lq/m;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v1}, Lq/n;->g(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
...
.method public f(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lq/n;->i(ILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
...
.method public final g(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
    ...
    .line 2
    invoke-virtual {p0, v0}, Lq/n;->k(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
    ...
    .line 8
    invoke-virtual {p0, p2}, Lq/n;->f(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method public final h(ILandroid/graphics/Bitmap$Config;)Lq/n$b;
    .locals 8
    ...
    .line 2
    invoke-static {p2}, Lq/n;->j(Landroid/graphics/Bitmap$Config;)[Landroid/graphics/Bitmap$Config;
    ...
    .line 3
    invoke-virtual {p0, v4}, Lq/n;->k(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
    ...
    invoke-virtual {p1, v0}, Lq/d;->c(Lq/m;)V

    .line 9
    iget-object p0, p0, Lq/n;->a:Lq/n$c;

    invoke-virtual {v5}, Ljava/lang/Integer;->intValue()I

    move-result p1

    invoke-virtual {p0, p1, v4}, Lq/n$c;->e(ILandroid/graphics/Bitmap$Config;)Lq/n$b;
...
.method public final k(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
    ...
    .line 3
    iget-object p0, p0, Lq/n;->c:Ljava/util/Map;
