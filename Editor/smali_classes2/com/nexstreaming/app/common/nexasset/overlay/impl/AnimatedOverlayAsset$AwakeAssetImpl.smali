...
.method private getImage(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    .line 4
    iget-object p0, p0, Lcom/nexstreaming/app/common/nexasset/overlay/impl/AnimatedOverlayAsset$AwakeAssetImpl;->bitmapCache:Landroid/util/LruCache;
...
.method private loadImage(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    :goto_1
    :try_start_2
    const-string p1, "AnimOverlayAsset"

    const-string v2, "Error reading frame image"
...
.method private loadSVG(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static {p1}, Lcom/larvalabs/svgandroid/SVGParser;->e(Ljava/io/InputStream;)Lr1/b;

    move-result-object p1

    .line 2
    invoke-virtual {p1}, Lr1/b;->a()Landroid/graphics/drawable/PictureDrawable;
    ...
    iget p0, p0, Lcom/nexstreaming/app/common/nexasset/overlay/impl/AnimatedOverlayAsset$AwakeAssetImpl;->vectorScale:F
    ...
    invoke-virtual {p1, v3, v3, v1, v2}, Landroid/graphics/drawable/PictureDrawable;->setBounds(IIII)V

    .line 6
    invoke-virtual {p1, v0}, Landroid/graphics/drawable/PictureDrawable;->draw(Landroid/graphics/Canvas;)V
...
.method public onAsleep(Lcom/nexstreaming/kminternal/nexvideoeditor/LayerRenderer;)V
    ...
    .line 2
    iget-object p0, p0, Lcom/nexstreaming/app/common/nexasset/overlay/impl/AnimatedOverlayAsset$AwakeAssetImpl;->reader:Lcom/nexstreaming/app/common/nexasset/assetpackage/AssetPackageReader;
