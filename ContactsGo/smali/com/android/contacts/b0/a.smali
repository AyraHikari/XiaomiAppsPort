.class public Lcom/android/contacts/b0/a;
.super Lcom/android/contacts/list/h1;
.source ""


# instance fields
.field private final O:Lcom/android/contacts/activities/ContactPhonePickerActivity;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/contacts/list/h1;-><init>(Landroid/content/Context;)V

    check-cast p1, Lcom/android/contacts/activities/ContactPhonePickerActivity;

    iput-object p1, p0, Lcom/android/contacts/b0/a;->O:Lcom/android/contacts/activities/ContactPhonePickerActivity;
...
.method public B(I)Landroid/net/Uri;
    ...
    :cond_0
    const-string p1, "MultiPhoneNumberListAdapter"
...
.method protected a(Landroid/content/Context;ILandroid/database/Cursor;ILandroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$d0;
    ...
    invoke-super/range {p0 .. p6}, Lcom/android/contacts/list/h1;->a(Landroid/content/Context;ILandroid/database/Cursor;ILandroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$d0;
...
.method protected a(Landroidx/recyclerview/widget/RecyclerView$d0;ILandroid/database/Cursor;I)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lcom/android/contacts/list/h1;->a(Landroidx/recyclerview/widget/RecyclerView$d0;ILandroid/database/Cursor;I)V
    ...
    invoke-virtual {p0, p4}, Lcom/android/contacts/b0/a;->B(I)Landroid/net/Uri;
    ...
    iget-object p3, p0, Lcom/android/contacts/b0/a;->O:Lcom/android/contacts/activities/ContactPhonePickerActivity;
...
.method public e(IZ)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/contacts/b0/a;->B(I)Landroid/net/Uri;

    move-result-object p1

    iget-object v0, p0, Lcom/android/contacts/b0/a;->O:Lcom/android/contacts/activities/ContactPhonePickerActivity;
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/contacts/b0/a;->O:Lcom/android/contacts/activities/ContactPhonePickerActivity;
...
.method public q(Z)Z
    ...
    invoke-virtual {p0}, Lcom/android/contacts/widget/b;->n()I
    ...
    invoke-virtual {p0, v2}, Lcom/android/contacts/b0/a;->B(I)Landroid/net/Uri;
    ...
    :cond_1
    iget-object v4, p0, Lcom/android/contacts/b0/a;->O:Lcom/android/contacts/activities/ContactPhonePickerActivity;
