...
.field private static final e:La/c/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "La/c/g<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/i;->e:La/c/g;
...
.method private static a(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p1}, La/a/o/d;->a()I
...
.method private a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v0, Landroidx/appcompat/app/i;->e:La/c/g;

    invoke-virtual {v0, p2}, La/c/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object p1, Landroidx/appcompat/app/i;->e:La/c/g;

    invoke-virtual {p1, p2, v0}, La/c/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, La/e/j/y;->x(Landroid/view/View;)Z
...
.method private b(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, p2, v3}, Landroidx/appcompat/app/i;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, p1, p2, v1}, Landroidx/appcompat/app/i;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
...
.method final a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_1
    invoke-static {p1, p4, p6, p7}, Landroidx/appcompat/app/i;->a(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/app/i;->a(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/p;
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->a(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/d;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/i;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->b(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageView;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;

    move-result-object p5

    :goto_2
    invoke-direct {p0, p5, p2}, Landroidx/appcompat/app/i;->a(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p4}, Landroidx/appcompat/app/i;->b(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
...
.method protected g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageView;
    .locals 1
...
.method protected i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    .locals 1
...
.method protected j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/p;
    .locals 1
