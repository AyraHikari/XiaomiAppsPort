...
.method public constructor <init>(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/Call;Lokhttp3/EventListener;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/connection/StreamAllocation;->routeDatabase()Lokhttp3/internal/connection/RouteDatabase;
...
.method public final deallocate(ZZZ)Ljava/net/Socket;
    ...
    .line 390
    :cond_3
    invoke-virtual {p0, p2}, Lokhttp3/internal/connection/StreamAllocation;->release(Lokhttp3/internal/connection/RealConnection;)V
...
.method public final findConnection(IIIZ)Lokhttp3/internal/connection/RealConnection;
    .locals 17
    ...
    .line 174
    invoke-virtual/range {p0 .. p0}, Lokhttp3/internal/connection/StreamAllocation;->releaseIfNoNewStreams()Ljava/net/Socket;
    ...
    .line 258
    invoke-virtual/range {p0 .. p0}, Lokhttp3/internal/connection/StreamAllocation;->routeDatabase()Lokhttp3/internal/connection/RouteDatabase;
...
.method public final findHealthyConnection(IIIZZ)Lokhttp3/internal/connection/RealConnection;
    ...
    .line 134
    :goto_0
    invoke-virtual {p0, p1, p2, p3, p4}, Lokhttp3/internal/connection/StreamAllocation;->findConnection(IIIZ)Lokhttp3/internal/connection/RealConnection;
...
.method public newStream(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Z)Lokhttp3/internal/http/HttpCodec;
    ...
    .line 113
    :try_start_0
    invoke-virtual/range {v0 .. v5}, Lokhttp3/internal/connection/StreamAllocation;->findHealthyConnection(IIIZZ)Lokhttp3/internal/connection/RealConnection;
...
.method public final release(Lokhttp3/internal/connection/RealConnection;)V
    .locals 3
...
.method public releaseAndAcquire(Lokhttp3/internal/connection/RealConnection;)Ljava/net/Socket;
    ...
    .line 497
    invoke-virtual {p0, v1, v2, v2}, Lokhttp3/internal/connection/StreamAllocation;->deallocate(ZZZ)Ljava/net/Socket;
...
.method public final releaseIfNoNewStreams()Ljava/net/Socket;
    ...
    .line 290
    invoke-virtual {p0, v1, v1, v0}, Lokhttp3/internal/connection/StreamAllocation;->deallocate(ZZZ)Ljava/net/Socket;
...
.method public final routeDatabase()Lokhttp3/internal/connection/RouteDatabase;
    .locals 2
...
.method public streamFinished(ZLokhttp3/internal/http/HttpCodec;JLjava/io/IOException;)V
    ...
    .line 309
    invoke-virtual {p0, p1, v0, p2}, Lokhttp3/internal/connection/StreamAllocation;->deallocate(ZZZ)Ljava/net/Socket;
