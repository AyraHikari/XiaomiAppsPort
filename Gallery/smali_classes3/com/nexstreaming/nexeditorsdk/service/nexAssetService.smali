...
.method private installAsset(Ljava/lang/String;Landroid/graphics/Bitmap;Lcom/nexstreaming/app/common/nexasset/store/json/AssetStoreAPIData$AssetInfo;Lcom/nexstreaming/nexeditorsdk/service/INexAssetInstallCallback;)V
    ...
    const-string v0, "installAsset fail!="
...
.method private onLoadInstalledAssetList(Lcom/nexstreaming/nexeditorsdk/service/INexAssetDataCallback;)V
    ...
    invoke-static {v1, v6}, Lcom/nexstreaming/app/common/util/n;->a(Landroid/content/Context;Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v4}, Lcom/google/gson_nex/Gson;->toJson(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    .line 241
    :try_start_0
    invoke-interface {v0, v1}, Lcom/nexstreaming/nexeditorsdk/service/INexAssetDataCallback;->onLoadAssetDatas(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private onReceivedAssetInfoData(IILjava/lang/String;)V
    ...
    const-string p3, "onReceivedAssetInfoData: bitmap index : "
    ...
    const-string p3, "onReceivedAssetInfoData: featuredAsset ="
