.class public Lcom/miui/gallery3d/exif/ExifModifier;
...
.field public final mTagToModified:Lcom/miui/gallery3d/exif/ExifData;


# direct methods
.method public constructor <init>(Ljava/nio/ByteBuffer;Lcom/miui/gallery3d/exif/ExifInterface;)V
    .locals 3
    ...
    .line 57
    :try_start_1
    invoke-static {v1, p2}, Lcom/miui/gallery3d/exif/ExifParser;->parse(Ljava/io/InputStream;Lcom/miui/gallery3d/exif/ExifInterface;)Lcom/miui/gallery3d/exif/ExifParser;
    ...
    invoke-virtual {p2}, Lcom/miui/gallery3d/exif/ExifParser;->getByteOrder()Ljava/nio/ByteOrder;

    move-result-object v2

    invoke-direct {v0, v2}, Lcom/miui/gallery3d/exif/ExifData;-><init>(Ljava/nio/ByteOrder;)V

    iput-object v0, p0, Lcom/miui/gallery3d/exif/ExifModifier;->mTagToModified:Lcom/miui/gallery3d/exif/ExifData;

    .line 59
    iget v0, p0, Lcom/miui/gallery3d/exif/ExifModifier;->mOffsetBase:I

    invoke-virtual {p2}, Lcom/miui/gallery3d/exif/ExifParser;->getTiffStartPosition()I
...
.method public commit()Z
    ...
    invoke-direct {v1, v2}, Lcom/miui/gallery3d/exif/ByteBufferInputStream;-><init>(Ljava/nio/ByteBuffer;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    :try_start_1
    new-array v3, v2, [Lcom/miui/gallery3d/exif/IfdData;

    .line 75
    iget-object v4, p0, Lcom/miui/gallery3d/exif/ExifModifier;->mTagToModified:Lcom/miui/gallery3d/exif/ExifData;
    ...
    .line 77
    invoke-virtual {v4, v6}, Lcom/miui/gallery3d/exif/ExifData;->getIfdData(I)Lcom/miui/gallery3d/exif/IfdData;
    ...
    .line 78
    invoke-virtual {v4, v7}, Lcom/miui/gallery3d/exif/ExifData;->getIfdData(I)Lcom/miui/gallery3d/exif/IfdData;
    ...
    .line 79
    invoke-virtual {v4, v8}, Lcom/miui/gallery3d/exif/ExifData;->getIfdData(I)Lcom/miui/gallery3d/exif/IfdData;
    ...
    .line 80
    invoke-virtual {v4, v9}, Lcom/miui/gallery3d/exif/ExifData;->getIfdData(I)Lcom/miui/gallery3d/exif/IfdData;
    ...
    .line 99
    :cond_4
    iget-object v7, p0, Lcom/miui/gallery3d/exif/ExifModifier;->mInterface:Lcom/miui/gallery3d/exif/ExifInterface;

    invoke-static {v1, v4, v7}, Lcom/miui/gallery3d/exif/ExifParser;->parse(Ljava/io/InputStream;ILcom/miui/gallery3d/exif/ExifInterface;)Lcom/miui/gallery3d/exif/ExifParser;
    ...
    .line 112
    invoke-virtual {v7}, Lcom/miui/gallery3d/exif/ExifTag;->getTagId()S

    move-result v8

    invoke-virtual {v0, v8}, Lcom/miui/gallery3d/exif/IfdData;->getTag(S)Lcom/miui/gallery3d/exif/ExifTag;
    ...
    .line 118
    :cond_6
    iget-object v9, p0, Lcom/miui/gallery3d/exif/ExifModifier;->mTagOffsets:Ljava/util/List;

    new-instance v10, Lcom/miui/gallery3d/exif/ExifModifier$TagOffset;

    invoke-virtual {v7}, Lcom/miui/gallery3d/exif/ExifTag;->getOffset()I

    move-result v11

    invoke-direct {v10, v8, v11}, Lcom/miui/gallery3d/exif/ExifModifier$TagOffset;-><init>(Lcom/miui/gallery3d/exif/ExifTag;I)V
    ...
    invoke-virtual {v0, v7}, Lcom/miui/gallery3d/exif/IfdData;->removeTag(S)V
    ...
    .line 121
    invoke-virtual {v4}, Lcom/miui/gallery3d/exif/ExifParser;->skipRemainingTagsInCurrentIfd()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 130
    invoke-virtual {v4}, Lcom/miui/gallery3d/exif/IfdData;->getTagCount()I
    ...
    :cond_c
    :try_start_3
    invoke-virtual {p0}, Lcom/miui/gallery3d/exif/ExifModifier;->modify()V
    :try_end_3
...
.method public final modify()V
    ...
    iget v1, v1, Lcom/miui/gallery3d/exif/ExifModifier$TagOffset;->mOffset:I

    invoke-virtual {p0, v2, v1}, Lcom/miui/gallery3d/exif/ExifModifier;->writeTagValue(Lcom/miui/gallery3d/exif/ExifTag;I)V
...
.method public final writeTagValue(Lcom/miui/gallery3d/exif/ExifTag;I)V
    .locals 5
    ...
    .line 159
    iget-object p1, p0, Lcom/miui/gallery3d/exif/ExifModifier;->mByteBuffer:Ljava/nio/ByteBuffer;
    ...
    .line 182
    invoke-virtual {p1, p2}, Lcom/miui/gallery3d/exif/ExifTag;->getBytes([B)V
