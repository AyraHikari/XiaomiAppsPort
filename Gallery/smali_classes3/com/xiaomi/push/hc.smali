...
.method public static a(Landroid/content/Context;Lcom/xiaomi/push/hf;)V
    ...
    new-instance v1, Lcom/xiaomi/push/hc$a;

    invoke-direct {v1, p0, p1}, Lcom/xiaomi/push/hc$a;-><init>(Landroid/content/Context;Lcom/xiaomi/push/hf;)V
...
.method public static a(Landroid/content/Context;Lcom/xiaomi/push/hf;Ljava/io/File;[B)V
    .locals 12
    ...
    :cond_5
    new-instance v9, Lcom/xiaomi/push/hk;

    invoke-direct {v9}, Lcom/xiaomi/push/hk;-><init>()V

    invoke-static {v9, v7}, Lcom/xiaomi/push/iq;->a(Lcom/xiaomi/push/ir;[B)V
    ...
    invoke-virtual {v9, v10, v11}, Lcom/xiaomi/push/hk;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    invoke-static {p0, p1, v0}, Lcom/xiaomi/push/hd;->a(Landroid/content/Context;Lcom/xiaomi/push/hf;Ljava/util/List;)V
...
.method public static synthetic b(Landroid/content/Context;Lcom/xiaomi/push/hf;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xiaomi/push/hc;->c(Landroid/content/Context;Lcom/xiaomi/push/hf;)V

    return-void
.end method

.method public static c(Landroid/content/Context;Lcom/xiaomi/push/hf;)V
    .locals 11
    ...
    sget-boolean v2, Lcom/xiaomi/push/hc;->a:Z

    if-nez v2, :cond_4

    const/4 v2, 0x1

    sput-boolean v2, Lcom/xiaomi/push/hc;->a:Z
    ...
    :cond_0
    invoke-static {p0}, Lcom/xiaomi/push/hc;->a(Landroid/content/Context;)V
    ...
    :cond_2
    invoke-static {p0, p1, v2, v3}, Lcom/xiaomi/push/hc;->a(Landroid/content/Context;Lcom/xiaomi/push/hf;Ljava/io/File;[B)V

    const/4 p1, 0x0

    invoke-static {p1}, Lcom/xiaomi/push/hb;->a(Z)V

    invoke-static {p0}, Lcom/xiaomi/push/hc;->b(Landroid/content/Context;)V

    sput-boolean p1, Lcom/xiaomi/push/hc;->a:Z
