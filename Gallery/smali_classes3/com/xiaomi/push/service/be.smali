...
.method public a(Lcom/xiaomi/push/fj;)V
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/push/service/be;->c(Lcom/xiaomi/push/fj;)V

    :cond_0
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/xiaomi/push/service/be;->b(Lcom/xiaomi/push/fj;)V
    :try_end_0
...
.method public final a(Lcom/xiaomi/push/gi;)V
    .locals 3

    invoke-virtual {p1}, Lcom/xiaomi/push/gi;->c()Ljava/lang/String;
...
.method public a(Lcom/xiaomi/push/gl;)V
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/push/service/be;->b(Lcom/xiaomi/push/gl;)V
    ...
    invoke-virtual {p1, v0}, Lcom/xiaomi/push/gl;->l(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v1}, Lcom/xiaomi/push/gl;->a(Ljava/lang/String;)Lcom/xiaomi/push/gi;

    move-result-object v1

    if-eqz v1, :cond_7

    invoke-virtual {p1}, Lcom/xiaomi/push/gl;->l()Ljava/lang/String;

    move-result-object p1

    const-string v2, "type"

    invoke-virtual {v1, v2}, Lcom/xiaomi/push/gi;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, p1}, Lcom/xiaomi/push/gl;->a(Ljava/lang/String;)Lcom/xiaomi/push/gi;

    move-result-object p1

    if-eqz p1, :cond_6

    invoke-virtual {p0, p1}, Lcom/xiaomi/push/service/be;->a(Lcom/xiaomi/push/gi;)V
    ...
    invoke-virtual {v1, v2, v0, p1}, Lcom/xiaomi/push/service/j;->a(Lcom/xiaomi/push/service/XMPushService;Ljava/lang/String;Lcom/xiaomi/push/gl;)V
...
.method public b(Lcom/xiaomi/push/fj;)V
    ...
    invoke-virtual {v0, v2, v1, p1}, Lcom/xiaomi/push/service/j;->a(Lcom/xiaomi/push/service/XMPushService;Ljava/lang/String;Lcom/xiaomi/push/fj;)V
    ...
    invoke-virtual {p1}, Lcom/xiaomi/push/fj;->a()[B

    move-result-object v0

    invoke-static {v0}, Lcom/xiaomi/push/dv$d;->a([B)Lcom/xiaomi/push/dv$d;
    ...
    :cond_2
    invoke-virtual {v0}, Lcom/xiaomi/push/dv$d;->a()Z
    ...
    :cond_3
    invoke-virtual {v0}, Lcom/xiaomi/push/dv$d;->a()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/xiaomi/push/dv$d;->b()Ljava/lang/String;
    ...
    sget-object p1, Lcom/xiaomi/push/ex;->T:Lcom/xiaomi/push/ex;
    ...
    invoke-static {v3, p1, v5, v2, v3}, Lcom/xiaomi/push/fh;->a(IIILjava/lang/String;I)V
    ...
    invoke-static {v0}, Lcom/xiaomi/push/dv$g;->a([B)Lcom/xiaomi/push/dv$g;
    ...
    invoke-virtual {v0}, Lcom/xiaomi/push/dv$g;->a()Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v0}, Lcom/xiaomi/push/dv$g;->b()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/xiaomi/push/dv$j;->a([B)Lcom/xiaomi/push/dv$j;

    move-result-object v0

    invoke-virtual {v0}, Lcom/xiaomi/push/dv$j;->b()Z
    ...
    invoke-virtual {v0}, Lcom/xiaomi/push/dv$j;->a()Lcom/xiaomi/push/dv$b;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/xiaomi/push/service/bv;->a(Lcom/xiaomi/push/dv$b;)V
    ...
    :cond_d
    invoke-static {}, Lcom/xiaomi/push/fh;->b()V
    ...
    invoke-virtual {p1}, Lcom/xiaomi/push/fj;->b()Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/xiaomi/push/dv$b;->a([B)Lcom/xiaomi/push/dv$b;
    ...
    invoke-virtual {v0, p1}, Lcom/xiaomi/push/service/bv;->a(Lcom/xiaomi/push/dv$b;)V
    ...
    invoke-static {v0}, Lcom/xiaomi/push/dv$k;->a([B)Lcom/xiaomi/push/dv$k;

    move-result-object v0

    iget-object v1, p0, Lcom/xiaomi/push/service/be;->a:Lcom/xiaomi/push/service/XMPushService;

    invoke-static {v1}, Lcom/xiaomi/push/dd;->a(Landroid/content/Context;)Lcom/xiaomi/push/dd;

    move-result-object v4

    invoke-virtual {v0}, Lcom/xiaomi/push/dv$k;->a()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0}, Lcom/xiaomi/push/dv$k;->b()Ljava/lang/String;

    move-result-object v6

    new-instance v7, Ljava/util/Date;

    invoke-virtual {v0}, Lcom/xiaomi/push/dv$k;->a()J
    ...
    invoke-virtual {v0}, Lcom/xiaomi/push/dv$k;->b()J

    move-result-wide v1

    invoke-direct {v8, v1, v2}, Ljava/util/Date;-><init>(J)V

    invoke-virtual {v0}, Lcom/xiaomi/push/dv$k;->c()I

    move-result v1

    mul-int/lit16 v9, v1, 0x400

    invoke-virtual {v0}, Lcom/xiaomi/push/dv$k;->e()Z

    move-result v10

    invoke-virtual/range {v4 .. v10}, Lcom/xiaomi/push/dd;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;IZ)V

    new-instance v0, Lcom/xiaomi/push/fj;

    invoke-direct {v0}, Lcom/xiaomi/push/fj;-><init>()V

    invoke-virtual {v0, v3}, Lcom/xiaomi/push/fj;->a(I)V
    ...
    invoke-direct {v1, p1, v0}, Lcom/xiaomi/push/service/bt;-><init>(Lcom/xiaomi/push/service/XMPushService;Lcom/xiaomi/push/fj;)V
    ...
    invoke-static {v0}, Lcom/xiaomi/push/dv$i;->a([B)Lcom/xiaomi/push/dv$i;
    ...
    invoke-virtual {v1, v3, v4}, Lcom/xiaomi/push/fj;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/xiaomi/push/fj;->e()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1, v3}, Lcom/xiaomi/push/fj;->a(Ljava/lang/String;)V

    new-instance v3, Lcom/xiaomi/push/dv$i;

    invoke-direct {v3}, Lcom/xiaomi/push/dv$i;-><init>()V

    invoke-virtual {v0}, Lcom/xiaomi/push/dv$i;->a()Z

    move-result v4

    if-eqz v4, :cond_11

    invoke-virtual {v0}, Lcom/xiaomi/push/dv$i;->a()Lcom/xiaomi/push/a;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/xiaomi/push/dv$i;->a(Lcom/xiaomi/push/a;)Lcom/xiaomi/push/dv$i;
    ...
    invoke-virtual {v1, v0, v2}, Lcom/xiaomi/push/fj;->a([BLjava/lang/String;)V

    iget-object v0, p0, Lcom/xiaomi/push/service/be;->a:Lcom/xiaomi/push/service/XMPushService;

    new-instance v2, Lcom/xiaomi/push/service/bt;

    invoke-direct {v2, v0, v1}, Lcom/xiaomi/push/service/bt;-><init>(Lcom/xiaomi/push/service/XMPushService;Lcom/xiaomi/push/fj;)V
    ...
    invoke-static {p1}, Lcom/xiaomi/push/dv$h;->a([B)Lcom/xiaomi/push/dv$h;
    ...
    invoke-virtual {p1}, Lcom/xiaomi/push/dv$h;->c()I
    ...
    invoke-virtual {p1}, Lcom/xiaomi/push/dv$h;->a()Ljava/lang/String;
...
.method public final b(Lcom/xiaomi/push/gl;)V
    .locals 9
    ...
    invoke-static {p1}, Lcom/xiaomi/push/gz;->a(Ljava/lang/String;)I
    ...
    invoke-static/range {v1 .. v8}, Lcom/xiaomi/push/gz;->a(Landroid/content/Context;Ljava/lang/String;JZZJ)V

    :cond_0
    return-void
.end method

.method public final c(Lcom/xiaomi/push/fj;)V
    .locals 9
