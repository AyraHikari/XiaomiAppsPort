...
.method public final excute(ILcom/xiaomi/phonenum/http/Request;Ljava/lang/String;)Lcom/xiaomi/phonenum/http/Response;
    ...
    .line 52
    invoke-virtual {p0, p1, p2}, Lcom/xiaomi/phonenum/obtain/HttpProxyParser;->httpRequest(ILcom/xiaomi/phonenum/http/Request;)Lcom/xiaomi/phonenum/http/Response;

    move-result-object p1

    .line 53
    invoke-virtual {p0, p3, p1}, Lcom/xiaomi/phonenum/obtain/HttpProxyParser;->followUp(Ljava/lang/String;Lcom/xiaomi/phonenum/http/Response;)Lcom/xiaomi/phonenum/http/Response;
...
.method public final followUp(Ljava/lang/String;Lcom/xiaomi/phonenum/http/Response;)Lcom/xiaomi/phonenum/http/Response;
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/phonenum/obtain/HttpProxyParser;->base64(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p2}, Lcom/xiaomi/phonenum/obtain/HttpProxyParser;->headersToJsonString(Ljava/util/Map;)Ljava/lang/String;

    move-result-object p2

    .line 77
    invoke-virtual {p0, p2}, Lcom/xiaomi/phonenum/obtain/HttpProxyParser;->base64(Ljava/lang/String;)Ljava/lang/String;
...
.method public final httpRequest(ILcom/xiaomi/phonenum/http/Request;)Lcom/xiaomi/phonenum/http/Response;
    .locals 2

    const-string p1, "HttpProxyParser"

    .line 57
    iget-object v0, p0, Lcom/xiaomi/phonenum/obtain/HttpProxyParser;->httpFactory:Lcom/xiaomi/phonenum/http/HttpFactory;

    invoke-virtual {v0}, Lcom/xiaomi/phonenum/http/HttpFactory;->createHttpClient()Lcom/xiaomi/phonenum/http/HttpClient;

    move-result-object v0

    .line 60
    :try_start_0
    invoke-interface {v0, p2}, Lcom/xiaomi/phonenum/http/HttpClient;->excute(Lcom/xiaomi/phonenum/http/Request;)Lcom/xiaomi/phonenum/http/Response;
    ...
    .line 63
    invoke-static {p1, v0, p2}, Lcom/xiaomi/accountsdk/utils/AccountLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public parse(ILjava/lang/String;)Lcom/xiaomi/phonenum/http/Response;
    ...
    .line 43
    invoke-virtual {p0, p2}, Lcom/xiaomi/phonenum/obtain/HttpProxyParser;->parseRequestJson(Lorg/json/JSONObject;)Lcom/xiaomi/phonenum/http/Request;

    move-result-object p2

    invoke-virtual {p0, p1, p2, v0}, Lcom/xiaomi/phonenum/obtain/HttpProxyParser;->excute(ILcom/xiaomi/phonenum/http/Request;Ljava/lang/String;)Lcom/xiaomi/phonenum/http/Response;
