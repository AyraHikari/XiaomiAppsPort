.class public Lcom/miui/gallery/provider/cloudmanager/method/cloud/addTo/task/id/copy/CopyShareMediaToOwnerAlbum;
.super Lcom/miui/gallery/provider/cloudmanager/method/cloud/addTo/task/id/copy/BaseCopy;
.source "CopyShareMediaToOwnerAlbum.java"
...
.method public execute(Landroidx/sqlite/db/SupportSQLiteDatabase;Lcom/miui/gallery/provider/cache/MediaManager;)J
    ...
    :try_start_0
    const-string v1, "COPY (CopyShareMediaToOwnerAlbum) => inserts : %s"
    ...
    const-string v4, "COPY (CopyShareMediaToOwnerAlbum) => inserts finish id [%d]"
